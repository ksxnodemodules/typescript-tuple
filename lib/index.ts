 ...
 */
export type IndexesEqual<Type, Tuple extends any[]> = Reverse<utils._IndexesEqual<Type, Tuple>>

/**
 * Find all indexes of a type in tuple
 * @example IndexesSubset<string, [0, false, 'a', 1, 'b', 'c']> → [2, 4, 5]
 */
export type IndexesSubset<Type, Tuple extends any[]> = Reverse<utils._IndexesSubset<Type, Tuple>>

/**
 * Find all indexes of a type in tuple
 * @example IndexesSuperset<'x', [number, boolean, string, 0, 'x', 'a' | 'b']> → [2, 4, 5]
 */
export type IndexesSuperset<Type, Tuple extends any[]> = Reverse<utils._IndexesSuperset<Type, Tuple>>
